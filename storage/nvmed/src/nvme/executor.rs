...
use executor::{LocalExecutor, Hardware};
...
impl Hardware for NvmeHw {
    ...
    fn try_submit(nvme: &Arc<Nvme>, sq_id: Self::SqId, success: impl FnOnce(Self::CmdId) -> Self::Sqe, fail: impl FnOnce()) -> Option<(Self::CqId, Self::CmdId)> {
